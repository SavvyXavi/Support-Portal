...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _manage_assets_assets_table_assets_table_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    /*! ./manage-assets/assets-table/assets-table.component */
    "./src/app/manage-assets/assets-table/assets-table.component.ts"); // Module Imports
      ...
      _createClass(AssetDetailComponent, [{
        ...
        value: function getItems() {
          ...
          this.filter.assetsBySerial(assetid).subscribe(function (returnedAsset) {
            _this26.asset = returnedAsset;

            _this26.filter.conByName(_this26.asset[0].Schedule).subscribe(function (returnedContractLength) {
              _this26.contractLength = returnedContractLength;
              _this26.contractDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](returnedContractLength);
              _this26.contractDataSource.sort = _this26.sort;
              _this26.contractDataSource.paginator = _this26.paginator;
            });

            _this26.filter.conByName(_this26.asset[0].Schedule).subscribe(function (returnedContract) {
              _this26.contract = returnedContract;
            });
          });
        }
      }, {
  ...
  function srcAppManageAssetsAssetsTableAssetsTableComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AssetsTableComponent.ɵfac = function AssetsTableComponent_Factory(t) {
      return new (t || AssetsTableComponent)();
    };
      ...
      _createClass(TicketDetailComponent, [{
        ...
        value: function getItems() {
          ...
          this.filter.ticketRefFilter(refNumber.substring(1)).subscribe(function (returnedTicket) {
            _this27.ticket = returnedTicket;

            _this27.filter.assetsBySerial(_this27.ticket[0].AssetIdentifier).subscribe(function (returnedAsset) {
              _this27.assetDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](returnedAsset);
              _this27.assetDataSource.sort = _this27.sort;
              _this27.assetDataSource.paginator = _this27.paginator;

              _this27.filter.conByName(returnedAsset[0].Schedule).subscribe(function (returnedContract) {
                _this27.contractDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](returnedContract);
