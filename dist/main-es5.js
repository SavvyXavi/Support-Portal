...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _manage_assets_contracts_contract_detail_assetlocfilter_asset_loc_filter_pipe__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    ...
    var _index_index_module__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    /*! ./index/index.module */
    "./src/app/index/index.module.ts");
    /* harmony import */


    var _portal_portal_module_portal_module__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    /*! ./portal/portal-module/portal.module */
    ...
    function () {
      ...
      _createClass(ManageAssetsComponent, [{
        ...
        value: function getAssets() {
          ...
          if (this.currentProfile.companypartner === 'Partner') {
            this.filter.partAssetsFilter(this.currentProfile).subscribe(function (returnedAssets) {
              _this44.assetLength = returnedAssets;
              _this44.assetDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](returnedAssets);
              _this44.assetDataSource.sort = _this44.sort;
              _this44.assetDataSource.paginator = _this44.paginator;
            });
          } else {
            this.filter.custAssetsFilter(this.currentProfile).subscribe(function (returnedAssetLength) {
              _this44.assetLength = returnedAssetLength;
              _this44.assetDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](returnedAssetLength);
              _this44.assetDataSource.sort = _this44.sort;
              _this44.assetDataSource.paginator = _this44.paginator;
            });
          }
      ...
      _createClass(TicketDetailComponent, [{
        ...
        value: function getItems() {
          ...
          this.filter.ticketRefFilter(refNumber.substring(1)).subscribe(function (returnedTicket) {
            _this45.ticket = returnedTicket;

            _this45.filter.assetsBySerial(_this45.ticket[0].AssetIdentifier).subscribe(function (returnedAsset) {
              _this45.assetDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](returnedAsset);
              _this45.assetDataSource.sort = _this45.sort;
              _this45.assetDataSource.paginator = _this45.paginator;

              _this45.filter.conByName(returnedAsset[0].Schedule).subscribe(function (returnedContract) {
                _this45.contractDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](returnedContract);
    ...
    function () {
      function TicketsComponent(api, formBuilder, authenticationService, filter) {
        ...
        this.authenticationService.currentUser.subscribe(function (typeName) {
          _this46.currentProfile = typeName;
        });
      }
      ...
      _createClass(TicketsComponent, [{
        ...
        value: function createTicket() {
          ...
          this.api.addTicket(this.ticketForm.value).subscribe(function (ticket) {
            var ticketData = _this47.ticketForm.value;
            ticketData = ticket;
          });
        }
      }, {
        ...
        value: function getTickets() {
          ...
          if (this.currentProfile.companypartner === 'Partner') {
            this.filter.partTicketsFilter(this.currentProfile).subscribe(function (returnedTickets) {
              _this49.testin = 'in the loop';
              _this49.ticketLength = returnedTickets;
              _this49.ticketDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](_this49.ticketLength);
              _this49.ticketDataSource.sort = _this49.sort;
              _this49.ticketDataSource.paginator = _this49.paginator;
            });
          } else {
            this.filter.cusTicketsFilter(this.currentProfile.company).subscribe(function (returnedTickets) {
              _this49.testin = 'Completely skipped';
              _this49.ticketLength = returnedTickets;
              _this49.ticketDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](returnedTickets);
              _this49.ticketDataSource.sort = _this49.sort;
              _this49.ticketDataSource.paginator = _this49.paginator;
            });
          }
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! import() | manage-assets-contracts-contracts-contracts-module */
          "manage-assets-contracts-contracts-contracts-module").then(__webpack_require__.bind(null,
          /*! ../../manage-assets/contracts/contracts/contracts.module */
          "./src/app/manage-assets/contracts/contracts/contracts.module.ts")).then(function (c) {
